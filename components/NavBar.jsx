...
export default function NavBar() {
    ...
    return (
        <>
            <div className={`w-full ${scrolled ? "bg-red-700/70" : "bg-red-700"} px-6 h-20 bg-red-700 text-white flex items-center justify-between fixed top-0 left-0 z-50`}>
                <div className='px-2 h-full flex items-center justify-center'>
                    <p className='uppercase font-semibold tracking-widest text-lg'><img src='https://i.postimg.cc/s2MZg3CT/favicon-removebg-preview.png' style={{height:"13vh"}}/></p>
                </div>
                ...
                <div className='px-2 h-full hidden items-center justify-center lg:flex ' >
                    {
                        user !== null ? (
                            <>
                                ...
                                <BiLogOut onClick={handleLogout} className=' cursor-pointer text-3xl hover:text-red-700 transition-all duration-700' />
                ...
                {
                    isOpen && (
                        <div ref={ref} className='flex w-full py-2 animate-fade-in-down  bg-red-700 transition-all fade duration-1000 absolute top-20 left-0  items-center justify-center flex-col '>
