                ...
                isLoading ? (
                    ...
                    <>
                        ...
                        <div className='w-full  py-20 flex items-center md:px-8 px-2  justify-center flex-col  '>
                            <div className='w-full h-40 bg-gray-50 text-black font-bold flex items-center justify-center flex-col'>
                                    ...
                                    <div className='flex items-center justify-center'>
                                        {
                                            JobDetails?.user?.email === user?.email ? (
                                                <p className='text-xs text-red-700'>unable Apply to your Own jobs</p>
                                            ) : (
                                                <div className='flex items-center justify-center  '>
