            ...
            <div className='w-full  py-20 flex items-center  justify-center flex-col'>
                ...
                <form onSubmit={handleSubmit} className="sm:w-1/2 w-full px-4 mx-4  h-full" >
                    ...
                    <div className='w-full mb-4  flex flex-col items-start justify-center'>
                        ...
                        {
                            error.salary && <p className="text-sm text-red-700">{error.salary}</p>
                        }
                    </div>
                    <div className='w-full mb-4  flex flex-col items-start justify-center'>
                        ...
                        {
                            error.email && <p className="text-sm text-red-700">{error.email}</p>
                        }
                    </div>
                    <div className='w-full mb-4  flex flex-col items-start justify-center'>
                        ...
                        {
                            error.company && <p className="text-sm text-red-700">{error.company}</p>
                        }
                    </div>
                    <div className='w-full mb-4  flex flex-col items-start justify-center'>
                        ...
                        {
                            error.description && <p className="text-sm text-red-700">{error.description}</p>
                        }
                    </div>
                    <div className='w-full mb-4  flex flex-col items-start justify-center'>
                        ...
                        {
                            error.job_category && <p className="text-sm text-red-700">{error.job_category}</p>
                        }
                    </div>
                    ...
                    <div className='w-full mb-4  flex flex-col items-start justify-center'>
                        ...
                        {
                            error.job_experience && <p className="text-sm text-red-700">{error.job_experience}</p>
                        }
                    </div>
                    <div className='w-full mb-4  flex flex-col items-start justify-center'>
                        ...
                        {
                            error.job_vacancy && <p className="text-sm text-red-700">{error.job_vacancy}</p>
                        }
                    </div>
                    <div className='w-full mb-4  flex flex-col items-start justify-center'>
                        ...
                        {
                            error.job_deadline && <p className="text-sm text-red-700">{error.job_deadline}</p>
                        }
                    </div>
                    <button type="submit" className='w-full py-2 rounded bg-red-700 text-white font-semibold tracking-widest'>Submit</button>
                </form>
            </div>
            <ToastContainer />
        </>
